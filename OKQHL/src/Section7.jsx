...
function Section7() {
  return (
    ...
    <div className="container py-5">
     ...
     <p className="main-content">The majority have suffered alteration all ipauminjected humours randomises.There are many variations of passages of lorem ipsum available, but the majority have.</p>
     </div>
     </div>
